...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/chriswiesanjaya/Documents/GitHub/language-inclusive-web-cul/.prisma/client-workshop",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), ".prisma/client-workshop/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), ".prisma/client-workshop/schema.prisma")
