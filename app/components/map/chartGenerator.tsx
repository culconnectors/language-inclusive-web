...
/**
 * Props for the ChartGenerator component
 */
...
/**
 * D3-based chart generator component
 * Features:
...
const ChartGenerator = ({ data, title }: ChartGeneratorProps) => {
    ...
    useEffect(() => {
        ...
        const y = d3
            .scaleBand()
            .domain(
                sortedData.map((d) => d.nationality || d.language || "Unknown")
            )
            .range([0, height])
            .padding(0.1);
        ...
        const bars = g
            ...
            .attr("fill", (d) =>
                color(d.nationality || d.language || "Unknown")
            )
            .attr("rx", 4)
            .attr("ry", 4)
            .attr("width", 0)
      ...
      `
                ...
                .style(
                    "left",
                    `${barBounds.right - containerBounds.left + 8}px`
                )
                .style(
                    "top",
                    `${
        ...
        const labels = g
            ...
            .attr(
                "y",
                (d) =>
                    (y(d.nationality || d.language || "Unknown") || 0) +
                    y.bandwidth() / 2
            )
            .attr("dy", "0.35em")
