            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="w-full max-w-3xl mx-auto space-y-6">
                <div className="flex justify-center gap-4 flex-wrap">
                  {[
                    { label: 'Social Events', key: 'events' },
                    { label: 'Language Workshops', key: 'workshops' },
                    { label: 'Community Friendly', key: 'community' },
                  ].map(({ label, key }) => (
                    <button
                      key={key}
                      onClick={() => setActiveType(key as ExplorationTypes)}
