...
/** Language-specific hero images mapping */
const heroImages = {
...
/** Order of languages in the carousel */
const languageOrder = ["en", "es", "zh", "fr", "vi", "id", "hi", "ja"];

/**
 * Landing page hero section with language carousel
 * Features:
 * - Animated language cycling
 * - Interactive image carousel
 * - Featured events and workshops sections
 * - Video popup for how-it-works
 */
export default function LandingHero() {
    ...
    // Calculate visible languages for carousel
    const visibleLanguages = useMemo(() => {
        return [-1, 0, 1, 2].map((offset) => {
            const index =
                (currentIndex + offset + languageOrder.length) %
    ...
    /**
     * Handles language change in the carousel
     * @param newLang - New language code to display
     */
                                        ...
                                        >
                                            ...
                                            >
                                                <Image
                                                    src={
                                                        heroImages[
                                                            lang as keyof typeof heroImages
                                                        ]
                                                    }
                                                    alt={
                                                        isCurrent
                                                            ? "Current cultural connection"
                                                            : "Adjacent cultural connection"
                                                    }
                                                    width={1200}
                                                    height={750}
