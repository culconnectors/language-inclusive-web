      ...
      <div className="bg-[#0A0F1D]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
          <div className="bg-[#1A1F2D]/80 backdrop-blur-sm rounded-xl p-8 text-white">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">{event.event_name}</h1>
          ...
          <div className="lg:col-span-2">
            <div className="prose prose-lg max-w-none">
              <div>
                ...
                <div dangerouslySetInnerHTML={{ __html: event.event_description }} />
                ...
                <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-blue-900 font-medium">Want to book or learn more?</p>
                      <p className="text-blue-700 mt-1">
                        Please visit the external event page using the button above.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-8 min-h-[160px]">
              ...
              <div className="space-y-3">
                <p className="text-gray-600 whitespace-nowrap">
                  <span className="font-medium">Start:</span> {formatDate(event.start_datetime)}
                </p>
                <p className="text-gray-600 whitespace-nowrap">
                  <span className="font-medium">End:</span> {formatDate(event.end_datetime)}
                </p>
              </div>
            </div>
            ...
            {event.venue && (
              <div className="bg-gray-50 rounded-xl p-8 min-h-[160px]">
                ...
                <div className="space-y-3">
                  <p className="font-medium">{event.venue.venue_name}</p>
                  <p className="text-gray-600">
                    {event.venue.venue_address}, {event.venue.venue_city}
                    {event.venue.venue_postcode && ` ${event.venue.venue_postcode}`}
                  </p>
                </div>
              </div>
            )}
            ...
            {event.organizer && (
              <div className="bg-gray-50 rounded-xl p-8 min-h-[160px]">
                ...
                <div className="space-y-3">
                  <p className="font-medium">{event.organizer.organizer_name}</p>
