/**
 * Loading skeleton for the event details page
 * Features:
 * - Displays animated placeholders for hero, content, and sidebar sections
 * - Mimics the layout of the event details page while loading
 * - Responsive design
 *
 * @returns {JSX.Element} The loading skeleton for the event page
 */
